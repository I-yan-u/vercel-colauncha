        ...
        <div className="w-full grid grid-cols-2 p-4 sm:p-12 gap-4 ">
          ...
          <div>
            <div className="grid w-full  items-center gap-1.5">
              ...
              <Input type="text" id="budget" required className="h-12" />
            </div>
          </div>
          ...
          <div>
            <div className="grid w-full text-xl  items-center gap-1.5">
              ...
              <Input type="text" id="time_frame" required className="h-12" />
            </div>
          </div>
          <div>
            <div className="grid w-full  items-center gap-1.5">
              <Label htmlFor="company-name">Company Name</Label>
              <Input type="text" id="company" required className="h-12" />
            </div>
          </div>
        </div>
