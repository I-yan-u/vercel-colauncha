...
const Hero = () => {
  return (
    ...
    <div className=" w-[75%] sm:w-[90%] pt-40 lg:pt-24 grid lg:grid-cols-2 mx-auto ">
      <div className="flex flex-col items-center lg:items-start  justify-center lg:justify-start gap-8">
       <div>
       <h1 className="font-extrabold text-[45px] lg:text=[70px] lg:w-[420px] leading-normal text-center lg:text-start pt-30 ">
